...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('atividades.create') }}" class="btn-novo btn btn-success">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered dataTable">
                ...
                @foreach($aItens as $pAjudadas)
                    <tr>
                        <td>
                            <a href="{{ route('atividades.edit', base64_encode($pAjudadas->id)) }}"
                               class="btn btn-primary" title="Editar">
                                <span class="fa fa-edit"></span>
                            </a>
                            <a href="{{ route('atividades.delete', base64_encode($pAjudadas->id)) }}"
